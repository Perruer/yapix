    ...
    function createHtml5(left, tp) {
      ...
      <body>
        <div class="m-header">
          ...
          <div class="nav">
            <a href="https://github.com/Perruer/yapix/tree/main/docs/documents">YApi</a>
          </div>
        </div>
        <div class="g-doc">
          ${left}
          ...
          ${tp}
            <footer class="m-footer">
              <p>Built with <a href="https://github.com/Perruer/yapix">Yapix</a>, based on YApi by <a href="https://github.com/YMFE/yapi">YMFE</a>.</p>
            </footer>
          </div>
        </div>
      </body>

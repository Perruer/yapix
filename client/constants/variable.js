module.exports = {
  ...
  docHref: {
    adv_mock_case: 'https://github.com/Perruer/yapix/blob/main/docs/documents/mock.md',
    adv_mock_script: 'https://github.com/Perruer/yapix/blob/main/docs/documents/adv_mock.md'
  }
};
